  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/ChicoTunda/MyStuff/blob/master/asn1.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "source": [
        ...
        "    \"\"\"\n",
        "\n",
        "    #converting everything to decimale\n",
        "    minutes_to_dec = minutes / 60\n",
        "    seconds_to_dec = seconds / 3600\n",
        "    \n",
        "    sum = degrees + minutes_to_dec + seconds_to_dec\n",
        "    return sum\n",
        "\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "    import math\n",
        "\n",
        "    #converts the given latitudes to radians so the equation is easier to read\n",
        "    rad_lat_1 = math.radians(latitude_line_1)\n",
        "    rad_lat_2 = math.radians(latitude_line_2)\n",
        "    \n",
        "    # Equation to find the subtended area\n",
        "    area = (math.pi / 180) * (EARTH_RADIUS ** 2) * abs(math.sin(rad_lat_1) - math.sin(rad_lat_2)) * abs(longitude_line_1 - longitude_line_2)\n",
        "    return area\n",
        "\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "        if latitude_line_1 <= latitude <= latitude_line_2 and longitude_line_1 < longitude <= longitude_line_2:\n",
        "          starbucks_counter += 1\n",
        "        \n",
        "\n",
        "    # Return the final total number of Starbucks\n",
        "    return starbucks_counter\n",
        "\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "    :rtype: Float\n",
        "    \"\"\"\n",
        "    data = load_starbucks_data(file_name)\n",
        "\n",
        "    starbucks_count = number_starbucks_within_area(data, latitude_line_1, latitude_line_2, longitude_line_1, longitude_line_2)\n",
        "\n",
        "    area = subtended_area(latitude_line_1, latitude_line_2, longitude_line_1, longitude_line_2)\n",
        "    \n",
        "    density = starbucks_count / area\n",
        "    \n",
        "    return density\n",
        "    \n",
        "abs(starbucks_per_square_kilometer(STARBUCKS_FILE_NAME, 30, 40, -120, -100) - 0.0014883245)\n",
